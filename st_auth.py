...
def authenticate_user(password: str) -> bool:
    ...
    hashed_password_attempt = bcrypt.hashpw(
        password.encode(), stored_salt.encode())
...
if __name__ == "__main__":
    """Create a password for the demo app."""

    parser = argparse.ArgumentParser()
    parser.add_argument("password", help="Password for the demo app.")
    args = parser.parse_args()
    store_demo_auth(args.password)
    print("Hashed and salted password stored in .env.")
